...
class TestColor < Test::Unit::TestCase
  ...
  def test_name
    assert_match(/\A[a-z]+\z/, FFakerTW::Color.name)
  end

  def test_hex_code
    assert_match(/\A\h{6}\z/, FFakerTW::Color.hex_code)
  end

  def test_rgb_array
    fake_array = FFakerTW::Color.rgb_array
  ...
  def test_rgb_list
    assert_match(
      ...
      FFakerTW::Color.rgb_list
    )
  end

  def test_rgba_array
    fake_array = FFakerTW::Color.rgba_array
  ...
  def test_rgba_list
    assert_match(
      ...
      FFakerTW::Color.rgba_list
    )
  end

  def test_hsl_array
    fake_array = FFakerTW::Color.hsl_array
  ...
  def test_hsl_list
    assert_match(
      ...
      FFakerTW::Color.hsl_list
    )
  end

  def test_hsla_array
    fake_array = FFakerTW::Color.hsla_array
