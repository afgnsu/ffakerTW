...
module FFakerTW
  ...
  module PhoneNumberAU
    ...
    # @see FFakerTW::PhoneNumberAU::MOBILE_OPERATORS_PREFIX
    #
    ...
    # @see FFakerTW::PhoneNumberAU::HOME_WORK_OPERATORS_PREFIX
    #
    ...
    def home_work_phone_number
      FFakerTW.numerify("(#{home_work_phone_prefix}) #### ####")
    end
    ...
    def international_home_work_phone_number
      FFakerTW.numerify("#{country_code} #{home_work_phone_prefix[1]} #### ####")
    end
