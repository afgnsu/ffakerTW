...
module FFakerTW
  ...
  module PhoneNumberSE
    ...
    def home_work_phone_number
      FFakerTW.numerify("0#{phone_number_format}")
    end

    def mobile_phone_number
      FFakerTW.numerify("0#{mobile_phone_number_format}")
    end
    ...
    def international_mobile_phone_number
      FFakerTW.numerify("#{country_prefix} (0)#{mobile_phone_number_format}")
    end

    def international_home_work_phone_number
      FFakerTW.numerify("#{country_prefix} (0)#{phone_number_format}")
    end
