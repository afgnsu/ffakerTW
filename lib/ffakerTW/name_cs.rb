...
module FFakerTW
  module NameCS
    ...
    #
    #   FFakerTW::NameCS.with_same_sex(:female)
    #     person.last_name  = FFakerTW::NameCS.last_name
    #     person.first_name = FFakerTW::NameCS.first_name
    #   end
    #
