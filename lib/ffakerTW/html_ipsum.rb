...
module FFakerTW
  ...
  # Requires FFakerTW::Lorem module
  module HTMLIpsum
    extend ModuleUtils
    extend self
    ...
    def fancy_string(count = 3, include_breaks = false)
      ...
      a = k([
        ...
        (a 2).to_s
      ] + FFakerTW::Lorem.paragraphs(count - 1))
    ...
    def words(word_count = 3)
      FFakerTW::Lorem.words(word_count).join(' ')
    end

    def sentence(word_count = 3)
      FFakerTW::Lorem.sentence(word_count)
    end

    def sentences(sentence_count = 3)
      FFakerTW::Lorem.sentences(sentence_count).join(' ')
    end
    ...
    def paragraphs(paragraph_count = 3)
      FFakerTW::Lorem.paragraphs(paragraph_count).join('<br>')
    end
  end
end
