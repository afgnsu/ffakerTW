...
module FFakerTW
  module PhoneNumberJA
    ...
    def home_phone_number
      disit = rand(1..4)
      FFakerTW.numerify("#{JAPAN_PREFIX}#{home_phone_number_format(disit)}")
    end

    def mobile_phone_number
      FFakerTW.numerify("#{JAPAN_PREFIX}#{mobile_phone_number_format}")
    end
    ...
    def international_home_phone_number
      disit = rand(1..4)
      FFakerTW.numerify("#{JAPAN_COUNTRY_CODE} #{home_phone_number_format(disit)}")
    end

    def international_mobile_phone_number
      FFakerTW.numerify("#{JAPAN_COUNTRY_CODE} #{mobile_phone_number_format}")
    end
