...
module FFakerTW
  ...
  module PhoneNumberCU
    ...
    # @see FFakerTW::PhoneNumberCU::MOBILE_OPERATORS_PREFIX
    #
    ...
    # @see FFakerTW::PhoneNumberCU::HOME_WORK_OPERATORS_PREFIX
    #
    ...
    def home_work_phone_number
      ...
      when 2 then FFakerTW.numerify("(#{phone_prefix}) ### ####")
      when 3 then FFakerTW.numerify("(#{phone_prefix}) ## ####")
      end
    end
    ...
    def international_mobile_phone_number
      FFakerTW.numerify("#{international_country_code}#{mobile_phone_prefix[1]} ### ####")
    end

    def international_home_work_phone_number
      phone_prefix = home_work_phone_prefix
      case phone_prefix.size
      when 2 then FFakerTW.numerify("#{international_country_code}#{phone_prefix[1]} ### ####")
      when 3 then FFakerTW.numerify("#{international_country_code}#{phone_prefix[1, 2]} ## ####")
      end
    end
    ...
    def e164_mobile_phone_number
      FFakerTW.numerify("#{country_code}#{mobile_phone_prefix[1]}#######")
    end

    def e164_home_work_phone_number
      phone_prefix = home_work_phone_prefix
      case phone_prefix.size
      when 2 then FFakerTW.numerify("#{e164_country_code}#{phone_prefix[1]}#######")
      when 3 then FFakerTW.numerify("#{e164_country_code}#{phone_prefix[1, 2]}######")
      end
    end
